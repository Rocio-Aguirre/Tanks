...
Menu::Menu(float width, float heigth){
    ...
    _text[0].setPosition(sf::Vector2f(width/2, heigth/(_maxNumItems+1)));
    ...
    _text[1].setPosition(sf::Vector2f(width/2, 40 + heigth/(_maxNumItems+1)));
    ...
    _text[2].setPosition(sf::Vector2f(width/2, 80 + heigth/(_maxNumItems+1)));
